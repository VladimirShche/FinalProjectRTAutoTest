...
class ChangePassPage(BasePage):
    #EX-013 метод проверки типа восстановления пароля по умолчанию
    ...
    #EX-014 метод проверки ссылки в подвале сайта на страницу с пользовательским соглашением
    def link_to_the_user_agreement_page(self):
        original_window = self.browser.current_window_handle
        assert len(self.browser.window_handle) == 1
    ...
    #EX-015 метод проверки на валидацию поля ввода номера телфона/почты/логина/лиц счёта( ввода валидного email)
    ...
    #EX-016 метод проверки восстановления пароля с незаполненным значением капчи
    ...
    #EX-017 метод проверки на валидацию поля ввода номера телефона/почты/логина/лиц счета (ввод валидного номера)
    ...
    #EX-018 метод проверки текстового поля на SQL-инъекции
    ...
    #EX-019 метод проверки кнопки на форму авторизации
    ...
    #EX-020 метод проверки восстановления пароля с незаполненными полями
